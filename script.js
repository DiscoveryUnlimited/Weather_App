...
const defaultImg = "https://images.unsplash.com/photo-1516912481808-3406841bd33c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1344&q=80";


// Create a card using input from location field
document.getElementById("input_container").addEventListener("submit", async(evt) => {
  evt.preventDefault();
  ...
  const locationInput = document.getElementById("user_input").value; //TODO change the ID.

  // Weather call
  const weather = await getCurrentWeather(locationInput);
